...
object playerInfo {
  ...
  def push_into(year: Int, playerName: String, country: String, matches: Int, runs: Int, wickets: Int): playerInfo = {
    ...
    def main(args: Array[String]): Unit = {
      val bufferedSource = scala.io.Source.fromFile("/Users/satyaprakash/IdeaProjects/code/First_Scala_Project/src/test/datafile/data.csv")
      var playerList = List(push_into(2020, "Kapil", "Nepal", 26, 220, 4))
